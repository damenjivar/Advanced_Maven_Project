...
public class Assertion_Automation {
	...
	public void verifyNinjaLastNameWarningMessageTest() {
		softassert.assertTrue(
				driver.findElement(By.xpath("//input[@id='input-lastname']/following-sibling::div[1]")).isDisplayed());
	...
	public void verifyNinjaTelephoneWarningMessageTest() {
		softassert.assertFalse(!driver.findElement(By.xpath("//input[@id='input-telephone']/following-sibling::div[1]"))
				.isDisplayed());
		softassert.assertAll();
	}
	...
	public void verifyNinjaPasswordWarningMessageTest() {
		softassert.assertTrue(driver
				.findElement(By.xpath("//input[@id='input-password']/following-sibling::div[@class='text-danger']"))
				.isDisplayed());
		softassert.assertAll();
	}
